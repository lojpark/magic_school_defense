...
function moveMadgoblin( e ){
	...
	/* 공격 */
		...
		else if( e.motionDelay <= 40 ){
			e.arm1A -= 12;
			e.arm2A += 4;
			e.headA -= 1.2;
			if( e.motionDelay == 36 ) isHit = true;
		}
...
function printMadgoblin( e, scr, img, context ){
	context.save();
